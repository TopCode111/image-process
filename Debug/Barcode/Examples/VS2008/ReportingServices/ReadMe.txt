1. Open Report.rdl in design mode, select "Properties" from the context menu on grey field:
...
2. Take a look at Image control below "ID" text, note its properties:
	MimeType	"image/png"
	Source		"DataBase"
